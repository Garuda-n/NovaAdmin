/**
 * NovaAdmin - Supplier Index Filter Alpine Component
 */
function ajaxSupplierFilter(config) {
    return {
        search: config.search || '',
        supplierType: config.supplierType || '',
        branchId: config.branchId || '',
        filterUrl: config.filterUrl || '/suppliers/filter',
        ...
        init() {
            ...
            document.addEventListener('click', (e) => {
                const paginationLink = e.target.closest('#supplier-table-container .pagination-wrapper a, #supplier-table-container nav a');
        ...
        openSupplierModal(id) {
            ...
            .catch(err => {
                ...
                this.modalHtml = '<div class="text-red-400 p-6 text-center">Failed to load supplier details.</div>';
            })
            .finally(() => {
        ...
        fetchData(targetUrl) {
            ...
            if (this.supplierType) formData.append('supplier_type', this.supplierType);
