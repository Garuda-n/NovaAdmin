...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'tracking_type' => ['required', 'integer', Rule::in([Product::TRACKING_QUANTITY, Product::TRACKING_INDIVIDUAL])],
            'item_generation_mode' => ['required', 'string', Rule::in([Product::ITEM_GEN_INDIVIDUAL, Product::ITEM_GEN_BULK])],
