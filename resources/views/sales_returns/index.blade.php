    ...
    <div class="py-6 bg-slate-100 dark:bg-[#0f1422] min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">
                        Track customer returned products, credit offsets, and payment refunds.
                    </p>
                </div>
            ...
            <div class="bg-white dark:bg-[#182035] rounded-xl p-4 shadow-sm border border-slate-200 dark:border-slate-800">
                <form action="{{ route('sales-returns.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search Return No / Customer..." class="w-full rounded-lg border-slate-300 dark:border-slate-700 bg-white dark:bg-[#0f1422] text-slate-900 dark:text-white text-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div class="flex items-center gap-2 md:col-start-4">
                        ...
                        <a href="{{ route('sales-returns.index') }}" class="py-2 px-3 bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-sm font-medium rounded-lg hover:bg-slate-300 transition">
                            Reset
                        </a>
                    </div>
                </form>
