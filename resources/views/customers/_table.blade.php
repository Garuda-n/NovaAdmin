                    ...
                    <tr class="hover:bg-[#212b40] transition duration-150">
                        ...
                        <td class="py-4 px-6">
                            @if($customer->customer_type === 'B2B')
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-purple-950/80 text-purple-300 border border-purple-800/50">
                                    B2B
                                </span>
                            @else
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-blue-950/80 text-blue-300 border border-blue-800/50">
                                    B2C
                                </span>
                            @endif
                        </td>
                        ...
                        <td class="py-4 px-6 text-slate-300 text-sm">
                            <div class="font-medium text-slate-200">{{ $customer->mobile }}</div>
                            @if($customer->email)
